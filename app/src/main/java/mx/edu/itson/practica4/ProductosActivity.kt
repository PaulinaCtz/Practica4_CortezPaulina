...
class ProductosActivity : AppCompatActivity() {
    ...
    fun agregarProductos (){
        ...
        antojitos.add(Product("Sopes", R.drawable.sopes , "Tortilla gruesa cubierta de frijoles, tu carne favorita, lechuga, queso fresco y crema Fried thick tortilla with beans, your choice of meat, lettuce, fresh cheese, sour cream and tomatoes. ", 3.65))
