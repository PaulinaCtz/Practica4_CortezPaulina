    ...
    fun agregarProductos (option:String?){
        ...
        when(option){
            "Antojitos"->{
                ...
                menu.add(Product("Sopes", R.drawable.sopes , "Tortilla gruesa cubierta de frijoles, tu carne favorita, lechuga, queso fresco y crema Fried thick tortilla with beans, your choice of meat, lettuce, fresh cheese, sour cream and tomatoes. ", 3.65))
            ...
            "Combinations"->{
                ...
                menu.add(Product("Mexican Burritos", R.drawable.combinationtaco, "Your choice of meat on a big burrito made of flour tortilla with rice, beans, lettuce, grilled onions, pico de gallo, guacamole and sour cream.", 11.99 ))
